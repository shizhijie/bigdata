package com.zjs.bwcx.bigdata.mr.fensi;
...
public class SharedFriendsStepTwo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputFormat.setInputPaths(job, new Path("F:/zx/wordcount/friends_output_1/part-r-00000"));
        FileOutputFormat.setOutputPath(job, new Path("F:/zx/wordcount/friends_output_2"));
