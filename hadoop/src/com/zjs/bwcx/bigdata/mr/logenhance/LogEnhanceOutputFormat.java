package com.zjs.bwcx.bigdata.mr.logenhance;
...
public class LogEnhanceOutputFormat extends FileOutputFormat<Text, NullWritable>{
    ...
    public RecordWriter<Text, NullWritable> getRecordWriter(TaskAttemptContext context)
        ...
        //org.apache.hadoop.fs.Path enhancePath = new org.apache.hadoop.fs.Path("F:/zx/wordcount/en/log.dat");
        //org.apache.hadoop.fs.Path tocrawlPath = new org.apache.hadoop.fs.Path("F:/zx/wordcount/crw/url.dat");
        
        org.apache.hadoop.fs.Path enhancePath = new org.apache.hadoop.fs.Path("/logenhance/enhancedlog/log.dat");
        org.apache.hadoop.fs.Path tocrawlPath = new org.apache.hadoop.fs.Path("/logenhance/tocrawl/url.dat");
